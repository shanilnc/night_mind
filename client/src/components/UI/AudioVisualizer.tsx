...
const AbstractBall: React.FC<any> = ({
  ...
  useEffect(() => {
    ...
    gsap.to(uniformsRef.current.RGBr, {
      duration: 1,
      value: Math.random() * 10,
    });
    gsap.to(uniformsRef.current.RGBg, {
      duration: 1,
      value: Math.random() * 10,
    });
    gsap.to(uniformsRef.current.RGBb, {
      duration: 1,
      value: Math.random() * 10,
    });
    gsap.to(uniformsRef.current.RGBn, {
      duration: 1,
      value: Math.random() * 2,
    });
    gsap.to(uniformsRef.current.RGBm, {
      duration: 1,
      value: Math.random() * 5,
    });
  }, [cameraZoom]);
