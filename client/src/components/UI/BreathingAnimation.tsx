...
export function BreathingAnimation({ isActive, onComplete }: BreathingAnimationProps) {
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/95 flex items-center justify-center z-50">
      <div className="text-center">
        <div className={`w-32 h-32 rounded-full bg-gradient-to-br from-blue-400 to-purple-500 mx-auto mb-8 transition-transform duration-4000 ease-in-out ${getScale()}`}></div>
        
        <div className="text-white">
          <h2 className="text-2xl font-light mb-4">{getPhaseText()}</h2>
          <div className="text-6xl font-light text-blue-300 mb-8">{countdown}</div>
