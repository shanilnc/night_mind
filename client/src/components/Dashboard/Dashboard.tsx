        ...
        <div className="bg-slate-800 rounded-lg p-6">
          ...
          {topTags.length > 0 ? (
            ...
            <p className="text-slate-400">
              Start conversations to see topic insights
            </p>
          )}
        </div>
              ...
              <>
                <div className="bg-slate-700 rounded-lg p-3">
                  <p className="text-slate-200 text-sm">
                    🌙 You tend to have deeper conversations around {peakHour}
                    :00. This seems to be when your mind is most active.
                  </p>
                </div>
                {topTags.length > 0 && (
                  <div className="bg-slate-700 rounded-lg p-3">
                ...
                <div className="bg-slate-700 rounded-lg p-3">
                  <p className="text-slate-200 text-sm">
                    💡 You average {avgMessagesPerConversation} messages per
                    session, showing you value thoughtful dialogue.
                  </p>
                </div>
              </>
            )}
            {totalConversations === 0 && (
              <div className="bg-slate-700 rounded-lg p-3">
                <p className="text-slate-400 text-sm">
                  Start having conversations to unlock personalized insights
                  about your thoughts and patterns.
                </p>
              </div>
            )}
          </div>
